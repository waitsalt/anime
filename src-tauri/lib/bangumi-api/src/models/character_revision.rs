...
pub struct CharacterRevision {
    ...
    pub data: Option<std::collections::HashMap<String, models::CharacterRevisionDataItem>>,
}

impl CharacterRevision {
    pub fn new(id: i32, r#type: i32, summary: String, created_at: String) -> CharacterRevision {
        CharacterRevision {
            id,
            r#type,
            creator: None,
