...
/// LegacySubjectSmallRatingCount : 各分值评分人数
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LegacySubjectSmallRatingCount {
...
impl LegacySubjectSmallRatingCount {
    /// 各分值评分人数
    pub fn new() -> LegacySubjectSmallRatingCount {
