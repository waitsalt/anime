...
pub struct PersonRevision {
    ...
    pub data: Option<std::collections::HashMap<String, models::PersonRevisionDataItem>>,
}

impl PersonRevision {
    pub fn new(id: i32, r#type: i32, summary: String, created_at: String) -> PersonRevision {
        PersonRevision {
            id,
            r#type,
            creator: None,
