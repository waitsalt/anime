...
pub struct PutUserEpisodeCollectionRequest {
    #[serde(rename = "type")]
    pub r#type: models::EpisodeCollectionType,
}

impl PutUserEpisodeCollectionRequest {
    pub fn new(r#type: models::EpisodeCollectionType) -> PutUserEpisodeCollectionRequest {
