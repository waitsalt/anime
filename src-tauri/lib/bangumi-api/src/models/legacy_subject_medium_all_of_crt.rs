...
pub struct LegacySubjectMediumAllOfCrt {
    /// 人物 ID
    ...
    pub actors: Option<Vec<models::LegacyMonoBase>>,
    /// 角色类型
    #[serde(rename = "role_name", skip_serializing_if = "Option::is_none")]
    pub role_name: Option<String>,
}

impl LegacySubjectMediumAllOfCrt {
    pub fn new() -> LegacySubjectMediumAllOfCrt {
