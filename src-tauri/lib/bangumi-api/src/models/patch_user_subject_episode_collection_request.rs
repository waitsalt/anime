...
pub struct PatchUserSubjectEpisodeCollectionRequest {
    #[serde(rename = "episode_id")]
    pub episode_id: Vec<i32>,
    #[serde(rename = "type")]
    pub r#type: models::EpisodeCollectionType,
}

impl PatchUserSubjectEpisodeCollectionRequest {
    pub fn new(episode_id: Vec<i32>, r#type: models::EpisodeCollectionType) -> PatchUserSubjectEpisodeCollectionRequest {
