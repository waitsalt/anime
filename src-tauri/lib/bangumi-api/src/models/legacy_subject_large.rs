...
pub struct LegacySubjectLarge {
    ...
    pub eps: Option<Vec<models::LegacyEpisode>>,
    /// 话数
    ...
    pub crt: Option<Vec<models::LegacySubjectMediumAllOfCrt>>,
    /// 制作人员信息
    #[serde(rename = "staff", skip_serializing_if = "Option::is_none")]
    pub staff: Option<Vec<models::LegacySubjectMediumAllOfStaff>>,
    /// 讨论版
    #[serde(rename = "topic", skip_serializing_if = "Option::is_none")]
    pub topic: Option<Vec<models::LegacyTopic>>,
    /// 评论日志
    #[serde(rename = "blog", skip_serializing_if = "Option::is_none")]
    pub blog: Option<Vec<models::LegacyBlog>>,
}

impl LegacySubjectLarge {
    pub fn new() -> LegacySubjectLarge {
        LegacySubjectLarge {
            id: None,
            url: None,
            r#type: None,
