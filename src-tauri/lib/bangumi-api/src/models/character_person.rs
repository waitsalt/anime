...
impl CharacterPerson {
    pub fn new(id: i32, name: String, r#type: models::CharacterType, subject_id: i32, subject_type: models::SubjectType, subject_name: String, subject_name_cn: String) -> CharacterPerson {
        CharacterPerson {
            id,
            name,
            r#type,
