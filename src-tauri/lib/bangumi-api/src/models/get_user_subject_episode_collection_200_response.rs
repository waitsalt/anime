...
pub struct GetUserSubjectEpisodeCollection200Response {
    #[serde(rename = "total")]
    pub total: i32,
    #[serde(rename = "limit")]
    pub limit: i32,
    ...
    pub data: Option<Vec<models::UserEpisodeCollection>>,
}

impl GetUserSubjectEpisodeCollection200Response {
    pub fn new(total: i32, limit: i32, offset: i32) -> GetUserSubjectEpisodeCollection200Response {
